...
$label_zone_1 = $availability_zone['label_availability_zone_1']
$label_zone_2 = $availability_zone['label_availability_zone_2']
$label_zone_3 = $availability_zone['label_availability_zone_3']
$label_zone_4 = $availability_zone['label_availability_zone_4']

$array_zone_1 = split($availability_zone['availability_zone_1'], ',')
$array_zone_2 = split($availability_zone['availability_zone_2'], ',')
$array_zone_3 = split($availability_zone['availability_zone_3'], ',')
$array_zone_4 = split($availability_zone['availability_zone_4'], ',')
